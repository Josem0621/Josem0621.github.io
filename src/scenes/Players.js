let player1Character = null;  // Almacena el personaje seleccionado por el jugador 1
let player2Character = null;  // Almacena el personaje seleccionado por el jugador 1
...
class Players extends Phaser.Scene {
	...
	editorCreate() {
		...
		this.player1Text = this.add.text(500, 50, "Jugador 1: Ningún personaje seleccionado", { color: "#f39c12", fontSize: "40px", fontStyle: "bold" });
	...
	updateSelectionVisuals(character) {
		...
		switch (character) {
			case 'dude1':
				this.triangles[0].setFillStyle(currentPlayer === 1 ? 0xFFFDA61C : 0x0000ff);  // Jugador 1 amarillo, Jugador 2 azul
				this.rectangles[0].setFillStyle(currentPlayer === 1 ? 0xFFFDA61C : 0x0000ff);
				break;
			case 'dude2':
				this.triangles[1].setFillStyle(currentPlayer === 1 ? 0xFFFDA61C : 0x0000ff);
				this.rectangles[1].setFillStyle(currentPlayer === 1 ? 0xFFFDA61C : 0x0000ff);
				break;
			case 'dude3':
				this.triangles[2].setFillStyle(currentPlayer === 1 ? 0xFFFDA61C : 0x0000ff);
				this.rectangles[2].setFillStyle(currentPlayer === 1 ? 0xFFFDA61C : 0x0000ff);
				break;
			case 'dude4':
				this.triangles[3].setFillStyle(currentPlayer === 1 ? 0xFFFDA61C : 0x0000ff);
				this.rectangles[3].setFillStyle(currentPlayer === 1 ? 0xFFFDA61C : 0x0000ff);
				break;
		}
	}
